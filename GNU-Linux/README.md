...
El comando mkdir (make directory) creará un directorio nuevo con el nombre que le pasemos como argumento, por ejemplo, para crear un directorio nuevo llamado directorio_4 podremos ejecutarlo de la siguiente manera:
```bash
~$ mkdir directorio_1
```
